...
| v37.F | planned | **Prompt upgrade.** Feed the agent the build contract + site conventions (read `CLAUDE.md`, inject the learnings doc) + *"a build failure may be environmental — don't assume it's your change."* Steers the agent on top of the now-sound environment. |

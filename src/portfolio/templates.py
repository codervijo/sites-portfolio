...
def claude_md_section_heading_hygiene() -> str:
    """`## Heading hygiene` section for docs/CLAUDE.md.

    Fleet-wide rule: before adding any new heading to a Markdown file,
    grep the current outline and confirm depth/label don't collide with
    existing ones. Lesson from sites/portfolio's docs/prd.md drift.
    """
    return """\
## Heading hygiene

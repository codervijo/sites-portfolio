...
- `data/portfolio.json` — canonical inventory + classifications, generated by `portfolio cleanup`. Each domain has `name, registrar, category, expires, ...`. Drives `category`, `wip`, and `project status` resolution.
